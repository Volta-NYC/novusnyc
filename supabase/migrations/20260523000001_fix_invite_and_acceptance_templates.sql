...
SET
  subject = 'Set up your Volta NYC member portal account',
  body    = '<!DOCTYPE html>
<html>
...
<body style="background-color:#ffffff;margin:0;padding:0;">
  <div style="font-family:Garamond,''EB Garamond'',serif;font-size:15px;line-height:1.7;color:#111111;max-width:520px;margin:0 auto;padding:32px 24px;">
    ...
    <p style="margin:0 0 16px;">You''ve been invited to set up your account on the Volta NYC member portal.</p>
...
<body style="background-color:#ffffff;margin:0;padding:0;">
  <div style="font-family:Garamond,''EB Garamond'',serif;font-size:15px;line-height:1.7;color:#111111;max-width:520px;margin:0 auto;padding:32px 24px;">
    ...
    <p style="margin:0 0 16px;">Here is the link to set up your Volta NYC member portal account.</p>
    <p style="margin:0 0 24px;">
      <a href="{{link}}" style="display:inline-block;background-color:#85CC17;color:#0d0d0d;font-weight:700;padding:7px 18px;border-radius:5px;text-decoration:none;font-size:13px;">Set Up Account</a>
    </p>
    <p style="margin:0 0 16px;font-size:13px;color:#555555;"><em>This link expires in 24 hours and can only be used once. If it expires, <a href="{{signupUrl}}" style="color:#85CC17;">click here</a> to request a new one.</em></p>
...
<body style="background-color:#ffffff;margin:0;padding:0;">
  <div style="font-family:Garamond,''EB Garamond'',serif;font-size:15px;line-height:1.7;color:#111111;max-width:520px;margin:0 auto;padding:32px 24px;">
    ...
    <p style="margin:0 0 16px;font-size:13px;color:#555555;"><em>This link expires in 24 hours. If it expires, you can always <a href="{{signupUrl}}" style="color:#85CC17;">request a new one here</a>.</em></p>
    <p style="margin:24px 0 0;">Best,<br>Ethan Zhang<br>Volta NYC</p>
  </div>
</body>
</html>',
