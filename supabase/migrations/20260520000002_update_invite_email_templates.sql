...
<body style="background-color:#ffffff;margin:0;padding:0;">
  <div style="font-family:Garamond,'EB Garamond',serif;font-size:15px;line-height:1.7;color:#111111;background-color:#ffffff;max-width:520px;margin:0 auto;padding:32px 24px;">
    ...
    <p style="margin:0 0 28px;">
      <a href="{{link}}" style="display:inline-block;background-color:#85CC17;color:#0d0d0d;font-weight:700;padding:7px 18px;border-radius:5px;text-decoration:none;font-size:13px;">Create Your Account</a>
    </p>
