...
function confirmedAccountAcceptanceEmail(name: string): string {
  ...
  return wrapper(
    `<p>Hi ${firstName},</p>` +
      `<p>Congratulations! You've been accepted to Volta NYC.</p>` +
      `<p>You'll be assigned to a project within the next week. Your team, tasks, and project details are organized in the member portal — sign in at <a href="https://voltanyc.org/members" style="color:#85CC17;">voltanyc.org/members</a>.</p>` +
...
export function buildConfirmedAccountAcceptanceTemplate(input: {
  ...
  return {
    subject: "Congratulations — You've been accepted to Volta NYC",
    ...
    text: [
      ...
      "",
      "You'll be assigned to a project within the next week. Your team, tasks, and project details are organized in the member portal — sign in at https://voltanyc.org/members.",
      "",
      "Best,",
      "Ethan Zhang",
      "Volta NYC",
