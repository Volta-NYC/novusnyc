        ...
        <div className="max-w-5xl mx-auto px-5 md:px-8 space-y-8">
          <AnimatedSection>
            <article id="reports-purpose" className="bg-n-bg border border-n-border rounded-2xl p-6 md:p-7">
              ...
              <p className="font-body text-n-muted mb-4">
              ...
              <p className="font-body text-n-muted">
          ...
          <AnimatedSection delay={0.06}>
            <article id="reports-coverage" className="bg-n-bg border border-n-border rounded-2xl p-6 md:p-7">
              ...
              <ul className="space-y-2">
                <li className="font-body text-n-ink flex items-start gap-2">
          ...
          <AnimatedSection delay={0.12}>
            <article className="bg-n-bg border border-n-border rounded-2xl p-6 md:p-7">
              ...
              <p className="font-body text-n-muted mt-4">
                For practical owner-facing playbooks and tool tutorials, see
                {" "}
                <Link href="/guides" className="text-n-purple hover:underline">Guides for Businesses</Link>.
              </p>
            </article>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.18}>
            <aside id="reports-publish" className="rounded-2xl border border-n-orange/35 bg-n-orange/5 p-6 md:p-7">
              ...
              <p className="font-body text-n-muted mb-5">
              ...
              <Link
                href="/apply"
                className="inline-flex items-center rounded-full bg-n-orange px-5 py-2.5 font-display font-bold text-sm text-n-ink hover:bg-n-orange-dark transition-colors"
              >
