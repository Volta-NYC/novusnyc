          ...
          <AnimatedSection>
            <div className="grid md:grid-cols-5 gap-12 items-start pb-12">
              ...
              <div className="md:col-span-3">
                {paused ? (
                  <div className="border border-v-border rounded-2xl bg-white p-8 text-center">
                    <div className="w-12 h-12 rounded-full bg-v-bg border border-v-border flex items-center justify-center mx-auto mb-4">
                      <svg className="w-5 h-5 text-v-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <circle cx="12" cy="12" r="10" /><line x1="12" y1="8" x2="12" y2="12" /><line x1="12" y1="16" x2="12.01" y2="16" />
                      </svg>
                    </div>
                    <h2 className="font-display font-bold text-v-ink text-xl mb-2">Applications Paused</h2>
                    <p className="font-body text-v-muted text-sm leading-relaxed max-w-xs mx-auto">
                      {message}
                    </p>
                  </div>
                ) : (
