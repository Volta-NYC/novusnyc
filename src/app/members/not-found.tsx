  ...
  return (
    <MembersLayout>
      <div className="max-w-md mx-auto mt-20 text-center">
        <p className="font-display font-bold text-[#85CC17] text-6xl mb-4">404</p>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <Link
            href="/members/me"
            className="rounded-full bg-[#85CC17] text-[#0D0D0D] font-display font-bold text-sm px-6 py-2.5 hover:bg-[#72b314] transition-colors"
          >
            Go to Overview
          </Link>
          <Link
