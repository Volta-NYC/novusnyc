...
export default function MyWorkPage() {
  ...
  // Upcoming deadlines: open tasks with due dates, sorted soonest first.
              ...
              <div className="bg-[#1C1F26] border border-white/8 rounded-xl p-3 space-y-2">
                {upcomingDeadlines.map((item, i) => (
                  <div key={i} className="flex items-start gap-3 px-2 py-1.5">
                    <span className="text-[10px] font-medium uppercase tracking-wider px-1.5 py-0.5 rounded flex-shrink-0 mt-0.5 bg-blue-500/15 text-blue-400">{item.type}</span>
                    <div className="flex-1 min-w-0">
