...
export default function MobileStickyAction() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-3 bottom-3 z-[60] md:hidden">
      <Link
        href={href}
        className="pointer-events-auto flex min-h-12 items-center justify-center rounded-lg border border-n-orange/55 bg-n-orange px-5 font-display text-sm font-bold text-n-ink shadow-[0_10px_24px_rgba(35,31,36,0.18)] transition-transform duration-200 active:scale-[0.98]"
      >
        {label}
      </Link>
    </div>
