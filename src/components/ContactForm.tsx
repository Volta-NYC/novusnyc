...
const COPY: Record<Lang, {
  ...
  en: { businessName: "Business Name *", ownerName: "Your Name *", email: "Email *", phone: "Phone Number", neighborhood: "Neighborhood", services: "What do you need help with?", referredBy: "Who referred you?", referredByPlaceholder: "e.g. a friend, flyer, social media…", message: "Tell us more", messagePlaceholder: "What's your biggest challenge right now?", submit: "Send Message", submitting: "Sending…", successTitle: "Got it. We'll be in touch.", successBody: "We'll review your submission and reach out within a few days.", errorMsg: "Something went wrong. Email us at info@voltanyc.org", footerNote: "We typically respond within 2–3 business days. Our services are 100% free.", dir: "ltr" },
  es: { businessName: "Nombre del negocio *", ownerName: "Su nombre *", email: "Correo electrónico *", phone: "Número de teléfono", neighborhood: "Vecindario", services: "¿Con qué necesita ayuda?", referredBy: "¿Quién lo refirió?", referredByPlaceholder: "ej. un amigo, volante, redes sociales…", message: "Cuéntenos más", messagePlaceholder: "¿Cuál es su mayor desafío ahora mismo?", submit: "Enviar mensaje", submitting: "Enviando…", successTitle: "Recibido. Nos pondremos en contacto.", successBody: "Revisaremos su solicitud y le responderemos en pocos días.", errorMsg: "Algo salió mal. Escríbanos a info@voltanyc.org", footerNote: "Generalmente respondemos en 2–3 días hábiles. Nuestros servicios son 100% gratuitos.", dir: "ltr" },
  zh: { businessName: "商户名称 *", ownerName: "您的姓名 *", email: "电子邮件 *", phone: "电话号码", neighborhood: "所在社区", services: "您需要哪方面的帮助？", referredBy: "谁推荐了您？", referredByPlaceholder: "例如：朋友、传单、社交媒体……", message: "请告诉我们更多", messagePlaceholder: "您目前面临的最大挑战是什么？", submit: "发送消息", submitting: "发送中…", successTitle: "已收到。我们会尽快联系您。", successBody: "我们将审核您的提交，并在几天内回复您。", errorMsg: "出现错误。请发送邮件至 info@voltanyc.org", footerNote: "我们通常在 2–3 个工作日内回复。我们的服务完全免费。", dir: "ltr" },
  ko: { businessName: "사업체명 *", ownerName: "성함 *", email: "이메일 *", phone: "전화번호", neighborhood: "동네", services: "어떤 도움이 필요하신가요?", referredBy: "누구에게 소개받으셨나요?", referredByPlaceholder: "예: 친구, 전단지, 소셜 미디어…", message: "더 알려주세요", messagePlaceholder: "현재 가장 어려운 점은 무엇인가요?", submit: "메시지 보내기", submitting: "전송 중…", successTitle: "접수되었습니다. 곧 연락드리겠습니다.", successBody: "제출하신 내용을 검토하고 며칠 내에 연락드리겠습니다.", errorMsg: "오류가 발생했습니다. info@voltanyc.org 으로 이메일 보내주세요.", footerNote: "보통 2–3 영업일 이내에 답변드립니다. 모든 서비스는 무료입니다.", dir: "ltr" },
  ar: { businessName: "اسم النشاط التجاري *", ownerName: "اسمك *", email: "البريد الإلكتروني *", phone: "رقم الهاتف", neighborhood: "الحي", services: "ما الذي تحتاج إلى مساعدة فيه؟", referredBy: "من أحالك إلينا؟", referredByPlaceholder: "مثل: صديق، منشور، وسائل التواصل الاجتماعي…", message: "أخبرنا المزيد", messagePlaceholder: "ما هو أكبر تحديك الآن؟", submit: "إرسال الرسالة", submitting: "جارٍ الإرسال…", successTitle: "تم الاستلام. سنتواصل معك قريبًا.", successBody: "سنراجع طلبك ونتواصل معك خلال أيام قليلة.", errorMsg: "حدث خطأ ما. راسلنا على info@voltanyc.org", footerNote: "نرد عادةً خلال 2–3 أيام عمل. خدماتنا مجانية 100%.", dir: "rtl" },
  fr: { businessName: "Nom de l'entreprise *", ownerName: "Votre nom *", email: "E-mail *", phone: "Numéro de téléphone", neighborhood: "Quartier", services: "De quoi avez-vous besoin ?", referredBy: "Qui vous a recommandé ?", referredByPlaceholder: "ex. un ami, un flyer, les réseaux sociaux…", message: "Dites-nous en plus", messagePlaceholder: "Quel est votre plus grand défi en ce moment ?", submit: "Envoyer le message", submitting: "Envoi en cours…", successTitle: "Reçu. Nous vous recontacterons.", successBody: "Nous examinerons votre demande et reviendrons vers vous dans quelques jours.", errorMsg: "Une erreur s'est produite. Écrivez-nous à info@voltanyc.org", footerNote: "Nous répondons généralement sous 2–3 jours ouvrés. Nos services sont 100% gratuits.", dir: "ltr" },
};
