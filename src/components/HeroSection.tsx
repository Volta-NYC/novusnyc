...
export default function HeroSection({ children }: { children?: ReactNode }) {
  ...
  return (
    <section ref={sectionRef} className="home-depth-section home-hero-depth relative overflow-hidden bg-[#17151a]">
      ...
      <div className="public-initial-viewport relative z-10 flex min-h-[100svh] flex-col items-center justify-center px-5 pb-16 pt-28 sm:pb-20 sm:pt-32 md:pb-24 md:pt-36">
        <motion.div
