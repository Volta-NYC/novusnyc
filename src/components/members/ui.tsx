...
const BADGE_COLORS: Record<string, string> = {
  ...
  "Ready to Contact":  "bg-yellow-500/15 text-yellow-400 border-yellow-500/20",
  Contacted:            "bg-blue-500/15 text-blue-400 border-blue-500/20",
  Responded:            "bg-cyan-500/15 text-cyan-400 border-cyan-500/20",
  "Call Scheduled":    "bg-purple-500/15 text-purple-400 border-purple-500/20",
  "Handed Off":        "bg-green-500/15 text-green-400 border-green-500/20",
  Idea:                 "bg-slate-500/15 text-slate-400 border-slate-500/20",
  Drafting:             "bg-blue-500/15 text-blue-400 border-blue-500/20",
